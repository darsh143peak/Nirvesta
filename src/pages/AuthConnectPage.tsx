        ...
        <div className="mx-auto grid max-w-6xl gap-10 py-12 lg:grid-cols-12">
          ...
          <section className="space-y-6 lg:col-span-7">
            ...
            <FutureIntegrationsPanel
              title="Future Broker Integrations"
              description="Zerodha, Upstox, and Groww stay visible here so you can demo the upcoming direct-connection roadmap."
            />
            <PortfolioUploadPanel
              title="Upload portfolio CSV files"
              description="Select one or many CSV files. Nirvesta merges the holdings by symbol and replaces the active basket used by the live dashboard."
            />
          </section>
        </div>
      </AppShell>
      ...
      <div className="relative mx-auto max-w-6xl overflow-hidden py-12">
        ...
        <div className="relative z-10 grid gap-12 lg:grid-cols-12">
          ...
          <section className="space-y-6 lg:col-span-7">
            ...
            <FutureIntegrationsPanel
              title="Future Broker Integrations"
              description="Zerodha, Upstox, and Groww are shown here as the planned next step after manual CSV import."
            />
            <PortfolioUploadPanel
              title="Manual CSV import"
              description="No broker connection yet? Upload your portfolio CSV files here and the backend will merge them into the active holdings basket."
            />
          </section>
        </div>
      </div>
